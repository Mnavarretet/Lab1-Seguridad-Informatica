...
#las siguientes lineas de codigo solo para verificar el funcionamiento

#CIFRADO
#print(Rot("Manuelon Musk", 8))
#Uivcmtwv Ucas

#en vigenere con heropassword de pass
#bmmqbtonvitd

#print(Rot("bmmqbtonvitd",12))
#Resultado del cifrado
#nyycnfazhufp

#DESCIFRADO
#print(Rot("nyycnfazhufp",-12))
#en vigenere
#resultado : uivcmtwv uca
#print(Rot("uivcmtwv uca", -8))
#resultado
#manuelon musk
#-------------------------------------------------------------------------------------------
#Desafio 2
#Mensaje : DuaqQbOzYukrcqgEnwdqjl

#DESCIFRADO
#print(Rot("DuaqQbOzYukrcqgEnwdqjl", -12))
#RioeEpCnMiyfqeuSbkrexz

#en vigenere con finispasswd
#mabwmacvumwairmamk mbv

#print(Rot("mabwmacvumwairmamk mbv", -8))
#resultado
#estoesunmensajesecreto.
